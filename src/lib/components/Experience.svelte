...
<div aria-label={'Experience Details for ' + title} class="flex flex-col">
	...
	<ul
		...
		class="list-disc list-outside flex flex-col items-start justify-start pl-5"
	>
	...
	{#if techStack.length > 0}
		<div
			aria-label={`Tech stack for ${title} at ${organization}`}
			class="flex flex-row flex-wrap gap-2 m-2"
		>
